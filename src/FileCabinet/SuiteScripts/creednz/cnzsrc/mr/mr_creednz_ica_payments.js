 ...
 */
define(['N/workflow', '../ssearches/searchlib', 'N/task'],
    /**
    ...
    (workflow, searchlib,task) => {
        ...
        const getInputData = (inputContext) => {
                log.debug({
                        title: 'Entry of MR send_payments',
                        details: 'START MR'
                });

                let mySearch = searchlib.customsearch_mr_get_ica_payments().run();
        ...
        const summarize = (summaryContext) => {
                let mrTask = task.create({
                        ...
                        scriptId: 'customscript_mr_creednz_payment_check',
                        deploymentId: 'customdeploy_mr_creednz_ica_payments',
                        params: {}
                });
                mrTask.submit();
        }
