...
define(['N/workflow','../ssearches/searchlib'],
    ...
    (workflow,searchlib) => {
        ...
        const getInputData = (inputContext) => {
            ...
            log.audit({
                title: 'Map/Reduce mr_creednz_vendor_check.js',
                details: 'Started getInputData'
            })
            return searchlib.customsearch_ss_get_status_from_creednz();
        }
        ...
        const map = (mapContext) => {
            ...
            let workflowInstanceId = workflow.initiate({
                workflowId: 'customworkflow_wf_creednz_vendor_all',
