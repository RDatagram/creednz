...
define(['../lib/creednz_api_lib'],
    ...
    (creednz_api_lib) => {
        ...
        const onAction = (scriptContext) => {
            ...
            let creedNzStatusTransactionsParse = creednz_api_lib.getCreednzVPaymentStatus(creednzExternalId);

            log.debug({title:"creedNzStatusResponse", details:creedNzStatusTransactionsParse});
            ...
            if (creednzRiskStatus) {
                ...
                scriptContext.newRecord.setValue({
                    fieldId: 'custbody_creednz_payment_status',
                    value: creednz_api_lib.regexRiskStatus(creednzRiskStatus)
                });
                scriptContext.newRecord.setValue({
                    fieldId: 'custbodycreednz_last_modified_date',
                    value: new Date()
                });
            }
        }
